...
class OptionsManager(object):
    ...
    def load_default(self):
        ...
        self.options = {
            'save_path': QStandardPaths.writableLocation(QStandardPaths.HomeLocation),
            'save_path_dirs': [
    ...
    def load_from_file(self):
        ...
        with open(self.settings_file, 'r', encoding="utf8") as settings_file:
            try:
    ...
    def save_to_file(self):
        ...
        #print("cfg: %s", self.settings_file)
