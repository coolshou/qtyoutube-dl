...
__author__ = 'coolshou yeh'
__contact__ = 'coolshou2060@gmail.com'
__projecturl__ = 'https://github.com/coolshou/qtyoutube-dl'

__appname__ = 'QtYoutube-dl'
__license__ = 'GPL2'

__description__ = ' PyQt5 base GUI for Youtube-dl'
